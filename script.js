...
const translations = {
    en: {
        ...
        hero: {
            ...
            subtitle4: ' and Infrastructure that scale.'
            subtitle5: 'Building Apps, SaaS, AI Systems and Infrastructure that scale',
    ...
    uk: {
        ...
        hero: {
            ...
            subtitle4: ' і Інфраструктура, що масштабуються.',
            subtitle5: 'Створюю Додатки, SaaS, ШІ системи і Інфраструктура, що масштабуються.'
    ...
    th: {
        ...
        hero: {
            ...
            subtitle3: ', ',
            highlight3: 'ระบบ AI',
            subtitle4: ' และ โครงสร้างพื้นฐาน ที่สามารถปรับขนาดได้'
            subtitle5: 'สร้างแอป, SaaS, ระบบ AI และ โครงสร้างพื้นฐาน ที่สามารถปรับขนาดได้'
    ...
    pt: {
        ...
        hero: {
            ...
            subtitle4: ' e Infraestrutura que escalam',
            subtitle5: 'A construir Apps, SaaS, Sistemas de IA e Infraestrutura que escalam'
    ...
    es: {
        ...
        hero: {
            ...
            highlight1: 'Aplicaciones',
            subtitle2: ', ',
            highlight2: 'SaaS',
            subtitle3: ', ',
            highlight3: 'Sistemas de IA',
            subtitle4: ' e Infraestructura que escalan',
            subtitle5: 'Construyendo Aplicaciones, SaaS, Sistemas de IA e Infraestructura que escalan'
    ...
    fr: {
        ...
        hero: {
            ...
            subtitle4: ' et Infrastructure qui passent à l'échelle',
            subtitle5: 'Construire des Apps, SaaS, Systèmes IA et Infrastructure qui passent à l'échelle'
    ...
    'zh-TW': {
        ...
        hero: {
            ...
            subtitle3: '、',
            highlight3: 'AI 系統',
            subtitle4: ' 和 基礎設施 實現規模化',
            subtitle5: '構建應用、SaaS、AI 系統 和 基礎設施，實現規模化'
            recentReleases: '最新發布',
            cta: '聯繫我'
        },
        about: {
    ...
    'zh-CN': {
        ...
        hero: {
            ...
            subtitle3: '、',
            highlight3: 'AI 系统',
            subtitle4: ' 和 基础设施 实现规模化',
            subtitle5: '构建应用、SaaS、AI 系统 和 基础设施，实现规模化'
            recentReleases: '最新发布',
            cta: '联系我'
        },
        about: {
    ...
    hi: {
        ...
        hero: {
            ...
            subtitle4: ' और इन्फ्रास्ट्रक्चर जो स्केल करते हैं',
            subtitle5: 'ऐप्स, SaaS, AI सिस्टम और इन्फ्रास्ट्रक्चर बना रहे हैं जो स्केल करते हैं'
            cta: 'संपर्क करें'
        },
        about: {
            tag: 'मेरे बारे में',
    ...
    ja: {
        ...
        hero: {
            ...
            subtitle3: '、',
            highlight3: 'AIシステム',
            subtitle4: ' と インフラを構築し、スケールさせます',
            subtitle5: 'アプリ、SaaS、AIシステム と インフラを構築し、スケールさせます'
    ...
    ar: {
        ...
        hero: {
            ...
            subtitle4: ' والبنية التحتية القابلة للتوسع',
            subtitle5: 'بناء تطبيقات، SaaS، أنظمة الذكاء الاصطناعي والبنية التحتية القابلة للتوسع'
    ...
    de: {
        ...
        hero: {
            ...
            subtitle4: ' und Infrastruktur, die skalieren',
            subtitle5: 'Apps, SaaS, KI-Systeme und Infrastruktur bauen, die skalieren'
    ...
    it: {
        ...
        hero: {
            ...
            subtitle4: ' e Infrastruttura che scalano',
            subtitle5: 'Costruisco App, SaaS, Sistemi IA e Infrastruttura che scalano'
    ...
    ko: {
        ...
        hero: {
            ...
            highlight3: 'AI 시스템',
            subtitle4: ' 및 인프라 구축',
            subtitle5: '앱, SaaS, AI 시스템 및 인프라 구축'
    ...
    ru: {
        ...
        hero: {
            ...
            title2: '',
            subtitle1: 'Создаю ',
            highlight1: 'приложения',
            subtitle2: ', ',
            highlight2: 'SaaS',
            subtitle3: ', ',
            highlight3: 'системы ИИ',
            subtitle4: ' и инфраструктура, которые масштабируются',
            subtitle5: 'Создаю приложения, SaaS-решения, системы ИИ и инфраструктура, которые масштабируются',
            cta: 'Связаться'
        },
        about: {
            tag: 'О себе',
    ...
    pl: {
        ...
        hero: {
            ...
            title2: '',
            subtitle1: 'Tworząc ',
            highlight1: 'Aplikacje',
            subtitle2: ', ',
            highlight2: 'SaaS',
            subtitle3: ', ',
            highlight3: 'systemy AI',
            subtitle4: ' oraz infrastruktura, które się skalują',
            subtitle5: 'Tworząc Aplikacje, rozwiązania SaaS, systemy AI oraz infrastruktura, które się skalują',
